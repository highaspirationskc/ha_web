class Admin::OlympicSeasonsController < Admin::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @olympic_season.save
        format.html { redirect_to admin_olympic_season_path(@olympic_season), notice: "Olympic season was successfully created." }
        format.json { render :show, status: :created, location: admin_olympic_season_path(@olympic_season) }
      else
  ...
  def update
    respond_to do |format|
      if @olympic_season.update(olympic_season_params)
        format.html { redirect_to admin_olympic_season_path(@olympic_season), notice: "Olympic season was successfully updated.", status: :see_other }
        format.json { render :show, status: :ok, location: admin_olympic_season_path(@olympic_season) }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_olympic_seasons_path, notice: "Olympic season was successfully destroyed.", status: :see_other }
