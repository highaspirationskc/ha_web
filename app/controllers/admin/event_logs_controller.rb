class Admin::EventLogsController < Admin::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @event_log.save
        format.html { redirect_to admin_event_log_path(@event_log), notice: "Event log was successfully created." }
        format.json { render :show, status: :created, location: admin_event_log_path(@event_log) }
      else
  ...
  def update
    respond_to do |format|
      if @event_log.update(event_log_params)
        format.html { redirect_to admin_event_log_path(@event_log), notice: "Event log was successfully updated.", status: :see_other }
        format.json { render :show, status: :ok, location: admin_event_log_path(@event_log) }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_event_logs_path, notice: "Event log was successfully destroyed.", status: :see_other }
