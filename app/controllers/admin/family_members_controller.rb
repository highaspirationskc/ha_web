  ...
  def create
    ...
    respond_to do |format|
      if @family_member.save
        format.html { redirect_to admin_family_member_path(@family_member), notice: "Family member was successfully created." }
        format.json { render :show, status: :created, location: admin_family_member_path(@family_member) }
      else
  ...
  def update
    respond_to do |format|
      if @family_member.update(family_member_params)
        format.html { redirect_to admin_family_member_path(@family_member), notice: "Family member was successfully updated.", status: :see_other }
        format.json { render :show, status: :ok, location: admin_family_member_path(@family_member) }
      else
