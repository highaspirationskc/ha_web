class EventTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @event_type.save
        format.html { redirect_to event_type_path(@event_type), notice: "Event type was successfully created." }
        format.json { render :show, status: :created, location: event_type_path(@event_type) }
      else
  ...
  def update
    respond_to do |format|
      if @event_type.update(event_type_params)
        format.html { redirect_to event_type_path(@event_type), notice: "Event type was successfully updated.", status: :see_other }
        format.json { render :show, status: :ok, location: event_type_path(@event_type) }
      else
